...
<nav class="navbar navbar-expand-lg navbar-light ">
  <div class="container-fluid d-flex justify-content-around">
    ...
    <div>
    <a href="index.php"><button type="submit" class="btn btn-outline-success mx-3" >ADD</button></a>
    <button type="submit" form="listForm" name="delete-product-btn" id="delete-product-btn" class="bg-danger text-light">MASS DELETE</button>
    </div>
  </div>
</nav>
<hr class="w-75">
