...
<nav class="navbar navbar-expand-lg navbar-light ">
    <div class="container-fluid d-flex justify-content-between">
      ...
      <div class= "mx-5">
      <button class="mx-2" type="submit" name="submit" id="submit" form="product_form">Save</button>
      <button class="mx-2" type="reset" form="product_form"><a href="productList.php"> Cancel</a></button>
      </div>
    </div>
  </nav>
  <hr>
  <div id="message"></div>
  <form action="abstract.php" method="post" class="product_form mx-4" id="product_form">
...
$(document).on("click", "#submit", function (e) {
  ...
  success:function(response){
    ...
    if(response=='<div class="alert bg-success text-white">data success</div>')
